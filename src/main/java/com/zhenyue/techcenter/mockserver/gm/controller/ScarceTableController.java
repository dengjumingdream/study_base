...
@ApiSort(0)
@RestController
@RequestMapping("/local/scrace1")
public class ScarceTableController {
    ...
    public JSON list(@RequestBody String params) {
        ...
        JSONObject _tempObject = new JSONObject();
        _tempObject.put("id", "1");
        _tempObject.put("num", 20);

        JSONArray dataArray = new JSONArray();
        dataArray.add(_tempObject);

        info.put("data", dataArray);
        ...
        info1.put("scarce_2", "1");
        info1.put("num_2", 20);


        JSONObject _tempObject1 = new JSONObject();
        _tempObject1.put("id", "1");
        _tempObject1.put("num", 20);

        JSONArray dataArray1 = new JSONArray();
        dataArray1.add(_tempObject);

        info1.put("data", dataArray);

        JSONArray resultData = new JSONArray();
        resultData.add(info);
        resultData.add(info1);
